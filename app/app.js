...
const translations = {
  en: {
    ...
    service_Surgery_Booking: "Surgery Booking",
    service_desc_Surgery_Booking: "Pre-surgery planning, booking request, and coordination for thoracic surgical procedures.",
  ...
  sq: {
    ...
    service_Surgery_Booking: "Termin për Operacion",
    service_desc_Surgery_Booking: "Planifikim para operacionit, kërkesë për termin dhe koordinim për procedurat e kirurgjisë torakale.",
